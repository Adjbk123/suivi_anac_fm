...
class RoleExtension extends AbstractExtension
{
    ...
    public function getFunctions(): array
    {
        return [
            ...
            new TwigFunction('can_create_mission', [$this->roleService, 'canCreateMission']),
            new TwigFunction('can_edit_mission', [$this->roleService, 'canEditMission']),
            new TwigFunction('can_validate_mission', [$this->roleService, 'canValidateMission']),
            new TwigFunction('can_delete_mission', [$this->roleService, 'canDeleteMission']),
